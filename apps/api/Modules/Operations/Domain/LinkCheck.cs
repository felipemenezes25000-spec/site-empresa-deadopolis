...
public sealed class LinkCheck : ITenantEntity
{
    private LinkCheck() { }

    public LinkCheck(Guid municipalityId, string url)
    {
        Id = Guid.NewGuid();
    ...
    public void RecordSuccess(int statusCode, long latencyMs, DateTimeOffset now)
    {
        ...
        ConsecutiveFailures++;
        State = ConsecutiveFailures >= 3 ? "UNAVAILABLE" : "DEGRADED";
    }
