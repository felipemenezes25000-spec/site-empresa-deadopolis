...
using MunicipalPlatform.Api.Modules.Search;
using MunicipalPlatform.Api.Modules.Services;
...
builder.Services.AddSingleton<MediaVariantService>();
...
app.MapSearchEnhancementEndpoints();
app.MapDepartmentDetailEndpoints();
